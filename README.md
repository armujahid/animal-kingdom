# Pokemon Kingdom Sample app

This sample app allows a user to create their own Pokemon Kingdom. They create their own
...
Each app can have different animals and territories. Pokemons and territories that only exist
